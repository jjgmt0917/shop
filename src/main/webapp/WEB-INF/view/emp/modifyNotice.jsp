...
<body>
	...
	<div class="main-container">
		...
		<div class="form-card">
			<form action="${pageContext.request.contextPath}/emp/modifyNotice?noticeCode=${notice.code}" method="post" id="noticeForm">
				<!-- 제목 -->
				<div class="form-group">
					<label class="form-label" for="title">
						제목<span class="required">*</span>
					</label>
					<input type="text" class="form-input" name="title" id="title" value="${notice.title}" required maxlength="100">
				...
				<div class="form-group">
					...
					<textarea class="form-textarea" name="content" id="content" required>${notice.content}</textarea>
					<div class="char-count">
